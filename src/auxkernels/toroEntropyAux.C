...
/******************************************************************************/
#include "toroEntropyAux.h"

registerMooseObject("ToroApp", toroEntropyAux);

template <>
InputParameters
validParams<toroEntropyAux>()
{
...
toroEntropyAux::toroEntropyAux(const InputParameters & parameters)
