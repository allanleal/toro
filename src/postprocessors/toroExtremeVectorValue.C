...
/******************************************************************************/
#include "toroExtremeVectorValue.h"
#include "MooseMesh.h"

#include <algorithm>
#include <limits>

registerMooseObject("ToroApp", toroExtremeVectorValue);

template <>
InputParameters
validParams<toroExtremeVectorValue>()
{
...
toroExtremeVectorValue::toroExtremeVectorValue(const InputParameters & parameters)
...
void
toroExtremeVectorValue::computeQpValue()
{
