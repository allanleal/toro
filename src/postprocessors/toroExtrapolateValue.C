...
/******************************************************************************/
#include "toroExtrapolateValue.h"

#include <algorithm>
#include <limits>

registerMooseObject("ToroApp", toroExtrapolateValue);

template <>
InputParameters
validParams<toroExtrapolateValue>()
{
...
toroExtrapolateValue::toroExtrapolateValue(const InputParameters & parameters)
...
void
toroExtrapolateValue::computeQpValue()
{
