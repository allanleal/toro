...
#include "toroHydroDarcy.h"

registerMooseObject("ToroApp", toroHydroDarcy);

template <>
InputParameters
validParams<toroHydroDarcy>()
{
...
toroHydroDarcy::toroHydroDarcy(const InputParameters & parameters)
...
Real
toroHydroDarcy::computeQpResidual()
{
...
Real
toroHydroDarcy::computeQpJacobian()
{
...
// Real
// toroHydroDarcy::computeQpOffDiagJacobian(unsigned int jvar)
// {
//   return 0.0;
// }
